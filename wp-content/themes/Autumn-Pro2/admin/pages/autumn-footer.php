...
add_filter('wpjam_theme_setting', function(){
	...
	$fields	= [
		...
		'foot_copyright'	=> ['title'=>'自定义页脚版权信息',	'type'=>'textarea',	'show_if'=>$show_if_1,	'description'=>'可使用html标签，留空则显示默认页脚版权信息'],

		'footer_icp'		=> ['title'=>'网站备案号',		'type'=>'text',		'show_if'=>$show_if_1, 'rows'=>4],
		'foot_link'			=> ['title'=>'友情链接',			'type'=>'checkbox', 'description'=>'激活“友情链接”，显示在首页底部，在【后台 - 连接】中添加友情链接'],
		'foot_timer'		=> ['title'=>'页面加载时间',		'type'=>'checkbox',	'show_if'=>$show_if_1, 'description'=>'页脚显示当前页面加载时间'],
		'xintheme_link'		=> ['title'=>'不显示主题版权信息',	'type'=>'checkbox',	'show_if'=>$show_if_1,	'description'=>'因为是收费主题，你可以勾选此选项来删除页脚的主题版权链接，当然，如果你保留链接，我们也对你表示感谢！'],
	];

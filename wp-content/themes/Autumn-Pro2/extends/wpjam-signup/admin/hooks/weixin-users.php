<?php
add_filter('wpjam_weixin_users_actions', function($actions){
	return array_merge($actions,[
		'bind_user'	=> ['title'=>'绑定用户',	'capability'=>is_multisite() ? 'manage_sites' : 'manage_options']
	]);
});

add_filter('wpjam_weixin_user_fields', function($fields, $action_key, $id){
...
add_filter('wpjam_weixin_user_list_action', function($result, $list_action, $id, $data){

...
add_action('wp_enqueue_scripts', function () {
	if (!is_admin()) {
		...
		wp_enqueue_style( 'style', get_stylesheet_directory_uri().'/static/css/style.css', array(), wp_get_theme()->get( 'Version' ) );
		wp_enqueue_style( 'fonts', get_stylesheet_directory_uri().'/static/fonts/iconfont.css', array(), wp_get_theme()->get( 'Version' ) );
		...
		wp_enqueue_script('autumn',	get_stylesheet_directory_uri() . '/static/js/autumn.min.js', ['jquery'], wp_get_theme()->get( 'Version' ), true);
		...
		wp_enqueue_script( 'xintheme_ajax', get_stylesheet_directory_uri() . '/static/js/ajax.js', ['jquery'], wp_get_theme()->get( 'Version' ), true );

...
== Description ==
[Product Page](https://accesspressthemes.com/wordpress-plugins/apex-notification-bar-lite/) | [Demo](http://demo.accesspressthemes.com/wordpress-plugins/apex-notification-bar-lite/) | [Documentation](https://accesspressthemes.com/documentation/apex-notification-bar-lite/) | [Premium Version](https://accesspressthemes.com/wordpress-plugins/apex-notification-bar)
...
= Premium Upgrade =
* For premium upgrade, please go [here](https://accesspressthemes.com/wordpress-plugins/apex-notification-bar)
...
* Fixed the issue regarding Settings tab.
* Few Backend CSS refinement work done.

= 2.0.0 =
* Fixed the issue regarding mobile notification bar .
* Few Backend CSS refinement work done.
...
= 1.0.8 =
* Compatibility check with latest New WordPress Version.
* Few Responsive CSS refinement work done.

= 1.0.7 =
* Backend and Frontend Few CSS refinement work done.

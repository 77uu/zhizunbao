...
class Smart_SEO_Tool_Sitemap {
	...
	public static function init(){
        ...
        }else if(self::cnf('sitemap_seo.active')){
    ...
    public static function ping($sitemap_url){
        ...
        if($cnf['google']){
            $ping_serv['google'] = 'http://www.google.com/webmasters/sitemaps/ping?sitemap=';
        }

        if($cnf['bing']) {
            $ping_serv['bing'] = 'http://www.bing.com/webmaster/ping.aspx?siteMap=';
        }

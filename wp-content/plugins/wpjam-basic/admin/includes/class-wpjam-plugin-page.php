...
class WPJAM_Menu_Page{
	...
	public  static function init(){
		...
		if(is_multisite() && is_network_admin()){
			$menu_pages	= apply_filters('wpjam_network_pages', []);
		}else{
			$menu_pages	= apply_filters('wpjam_pages', self::$menu_pages);
		}
...
class WPJAM_Plugin_Page extends WPJAM_Menu_Page{
	...
	public function page_title($page_setting){
		...
		$summary	= $page_setting['summary'] ?? null;

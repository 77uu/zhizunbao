...
if(is_admin()){
	add_filter('wpjam_pages',					['WPJAM_Basic', 'filter_menu_pages']);
	add_filter('wpjam_network_pages',			['WPJAM_Basic', 'filter_menu_pages']);
	...
	// 	add_filter('site_transient_update_core',	['WPJAM_Hook', 'filter_site_transient_update_core']);
	// 	add_filter('site_transient_update_plugins',	['WPJAM_Hook', 'filter_site_transient_update_plugins']);
	// }
}